...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/pages/admin/communications/index.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/pages/admin/communications/index.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      entity: "Comunicado",
      newEntity: "Nuevo Comunicado",
      entityTable: "communications",
      entityAdd: "communication/add",
      entityDelete: "communication/delete/",
      object: {
        info: "",
        startDate: "",
        finalDate: ""
  ...
  methods: {
    ...
    getItems: function getItems() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default()({
        ...
        var t = _this2;
        console.log(resp.data.communications, "<---");
        t.items = resp.data.communications; //resolve(resp)
    ...
    destroy: function destroy(id) {
      var t = this;
      axios__WEBPACK_IMPORTED_MODULE_0___default()({
        url: this.entityDelete + id,
        method: 'POST'
      }).then(function (resp) {
        t.showDeleteMsg();
        t.getItems(); //resolve(resp)
      })["catch"](function (err) {//commit('auth_error', err)
        //reject(err)
      });
    },
    page: function page(url) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default()({
        ...
        var t = _this3;
        t.items = resp.data.links;

        if (resp.data.communications.next_page_url) {
          t.nextUrl = resp.data.communications.next_page_url;
        } else {
          t.nextUrl = "";
        }

        if (resp.data.communications.prev_page_url) {
          t.previousUrl = resp.data.communications.prev_page_url;
        } else {
          t.previousUrl = "";
        } //resolve(resp)
  ...
  notifications: {
    showSuccessMsg: {
      ...
      message: 'Comunicado añadido con éxito!'
    },
    showErrorMsg: {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/pages/admin/communications/index.vue?vue&type=template&id=26d33d0a&":
/*!******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/pages/admin/communications/index.vue?vue&type=template&id=26d33d0a& ***!
  \******************************************************************************************************************************************************************************************************************************/
          ...
          _c(
            ...
            [
              _c("CRow", [
                _c(
                  "label",
                  { staticClass: "typo__label pt-4", attrs: { for: "info" } },
                  [_vm._v("Información")]
                ),
                _vm._v(" "),
                _c("input", {
                  ...
                  class: {
                    "is-invalid": _vm.submitted && _vm.errors.has("info")
                  },
                  attrs: {
                    type: "text",
                    name: "info",
                  ...
                  domProps: { value: _vm.object.info },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.$set(_vm.object, "info", $event.target.value)
                    }
                  }
                }),
                _vm._v(" "),
              ...
              _c("CRow", { staticClass: "form-group" }, [
                _c(
                  "label",
                  { staticClass: "typo__label", attrs: { for: "startDate" } },
                  [_vm._v("Fecha Inicio")]
                ),
                _vm._v(" "),
                _c("input", {
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.object.startDate,
                      expression: "object.startDate"
                    },
                    {
                      name: "validate",
                      rawName: "v-validate",
                  ...
                  staticClass: "form-control",
                  class: {
                    "is-invalid": _vm.submitted && _vm.errors.has("startDate")
                  },
                  attrs: { type: "date", name: "startDate", id: "startDate" },
                  domProps: { value: _vm.object.startDate },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.$set(_vm.object, "startDate", $event.target.value)
                    }
                  }
                }),
                _vm._v(" "),
              ...
              _c("CRow", { staticClass: "form-group" }, [
                _c(
                  "label",
                  { staticClass: "typo__label", attrs: { for: "finalDate" } },
                  [_vm._v("Fecha Final")]
                ),
                _vm._v(" "),
                _c("input", {
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.object.finalDate,
                      expression: "object.finalDate"
                    },
                    {
                      name: "validate",
                      rawName: "v-validate",
                  ...
                  staticClass: "form-control",
                  class: {
                    "is-invalid": _vm.submitted && _vm.errors.has("finalDate")
                  },
                  attrs: { type: "date", name: "finalDate", id: "startDate" },
                  domProps: { value: _vm.object.finalDate },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.$set(_vm.object, "finalDate", $event.target.value)
                    }
                  }
                }),
                _vm._v(" "),
                _vm.errors.has("finalDate")
                  ? _c("div", { staticClass: "invalid-feedback" }, [
                      _vm._v(_vm._s(_vm.errors.first("finalDate")))
                    ])
                  : _vm._e()
              ])
            ],
...
/***/ "./resources/js/views/pages/admin/communications/index.vue":
/*!*****************************************************************!*\
  !*** ./resources/js/views/pages/admin/communications/index.vue ***!
  \*****************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_26d33d0a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=26d33d0a& */ "./resources/js/views/pages/admin/communications/index.vue?vue&type=template&id=26d33d0a&");
/* harmony import */ var _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/admin/communications/index.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _index_vue_vue_type_template_id_26d33d0a___WEBPACK_IMPORTED_MODULE_0__["render"],
  _index_vue_vue_type_template_id_26d33d0a___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/admin/communications/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/views/pages/admin/communications/index.vue?vue&type=script&lang=js&":
/*!******************************************************************************************!*\
  !*** ./resources/js/views/pages/admin/communications/index.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib??ref--4-0!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./index.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/pages/admin/communications/index.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/views/pages/admin/communications/index.vue?vue&type=template&id=26d33d0a&":
/*!************************************************************************************************!*\
  !*** ./resources/js/views/pages/admin/communications/index.vue?vue&type=template&id=26d33d0a& ***!
  \************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_26d33d0a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./index.vue?vue&type=template&id=26d33d0a& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/pages/admin/communications/index.vue?vue&type=template&id=26d33d0a&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_26d33d0a___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_26d33d0a___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
